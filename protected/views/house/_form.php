...
<?php echo $form->textFieldRow($model,'address_1',array('class'=>'span3','maxlength'=>256)); ?>

<?php echo $form->textFieldRow($model,'address_2',array('class'=>'span3','maxlength'=>256)); ?>

<?php echo $form->textFieldRow($model,'city',array('class'=>'span3','maxlength'=>19)); ?>

<?php echo $form->dropDownListRow($model, 'state', States::getStates(array("US"), true),
    array('prompt' => 'Select State')); ?>

<?php echo $form->textFieldRow($model,'zip_code',array('class'=>'span4')); ?>
